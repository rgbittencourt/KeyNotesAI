    ...
    <main className="app-shell">
      ...
      <section className="workspace">
        ...
        <div className="content">
          {active !== "Visão geral" ? <FeatureView active={active} notify={notify} recordings={deviceRecordings} /> : <><section className="welcome"><div><p className="eyebrow">QUINTA-FEIRA, 20 DE AGOSTO</p><h1>Bom dia, Rogério.</h1><p>Você foca na reunião, a IA cuida do resto.</p></div><button className={`record ${recording ? "recording" : ""}`} onClick={toggleRecording}><i />{recording ? "Encerrar e salvar" : "Gravar nova reunião"}</button></section>
