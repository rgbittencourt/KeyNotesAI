import type{MeetingAction,MeetingAnalysis,MeetingDecision}from"./local-processing";

type SemanticPayload={summary:string;themes:string[];actions:Array<Omit<MeetingAction,"id"|"done">>;decisions:Array<Omit<MeetingDecision,"id"|"resolved">>};
...
export async function analyzeTranscriptSemantically(transcript:string):Promise<MeetingAnalysis>{
 ...
 return{summary:body.summary,themes:body.themes||[],actions,decisions,minutes,processedAt:new Date().toISOString(),processingMode:"semantic"};
}
