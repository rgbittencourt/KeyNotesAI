...
const analysisSchema={
 type:"object",additionalProperties:false,required:["summary","themes","mindMap","actions","decisions"],properties:{
  ...
  mindMap:{type:"object",additionalProperties:false,required:["title","branches"],properties:{title:{type:"string",description:"Título central curto, com duas a oito palavras, representativo da conversa ou aula."},branches:{type:"array",minItems:2,maxItems:6,items:{type:"object",additionalProperties:false,required:["topic","summary","subtopics"],properties:{topic:{type:"string",description:"Tópico principal curto, preferencialmente com duas a seis palavras."},summary:{type:"string",description:"Explicação concisa do tópico usada para preservar seu contexto semântico."},subtopics:{type:"array",minItems:1,maxItems:4,items:{type:"string",description:"Rótulo visual curto, preferencialmente com até doze palavras."}}}}}}},
...
const instructions=`Você é um analista de reuniões, conversas e aulas em português brasileiro. Analise somente a transcrição fornecida. Produza uma síntese temática: selecione assuntos materialmente importantes, resultados, argumentos e consequências; não resuma apenas o começo nem siga a ordem cronológica. Gere também um mapa mental hierárquico abrangente, da esquerda para a direita, projetado para caber com legibilidade em uma única página A4 horizontal: um título central curto, de dois a seis tópicos principais e, para cada tópico, uma explicação concisa e no máximo quatro subtópicos visuais curtos. Quando houver mais conteúdo, agrupe ideias próximas e priorize o que for materialmente mais importante; nunca crie ramos redundantes nem frases longas. Os subtópicos devem cobrir conceitos, argumentos, exemplos, relações, conclusões, dúvidas e qualificadores relevantes encontrados ao longo de toda a transcrição. Antes de finalizar o mapa, confira sua consistência e cobertura contra a síntese, os temas, as ações e as decisões/pendências/bloqueios que você próprio produziu. Nenhum achado material desses campos deve desaparecer do mapa: incorpore prioridade, prazo, responsável ausente, incerteza, intenção, confirmação ou ausência de confirmação quando forem semanticamente relevantes. Use rótulos de preferência com até doze palavras, sem parágrafos e sem repetir a mesma ideia em ramos diferentes. Organize por afinidade semântica. Não limite o mapa a decisões e tarefas. Diferencie rigorosamente decisão confirmada, sugestão, pergunta, intenção, pendência e bloqueio. Uma ação exige compromisso ou encaminhamento suficientemente claro. Extraia responsável e prazo somente quando sustentados pelo texto; caso contrário use exatamente "A confirmar" e "Sem prazo". Cada item deve conter uma evidência curta copiada ou minimamente normalizada da transcrição e confiança entre 0 e 1. Não transforme frases negadas, hipóteses ou exemplos em fatos. Não invente nomes, datas, valores ou conclusões. Una duplicatas e preserve divergências relevantes.`;
