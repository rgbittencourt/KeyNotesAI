...
const analysisSchema={
 type:"object",additionalProperties:false,required:["summary","themes","mindMap","actions","decisions"],properties:{
  ...
  mindMap:{type:"object",additionalProperties:false,required:["title","branches"],properties:{title:{type:"string",description:"Título central curto, com duas a oito palavras, representativo da conversa ou aula."},branches:{type:"array",minItems:2,maxItems:8,items:{type:"object",additionalProperties:false,required:["topic","summary","subtopics"],properties:{topic:{type:"string",description:"Tópico principal curto, preferencialmente com duas a seis palavras."},summary:{type:"string",description:"Explicação concisa do tópico usada para preservar seu contexto semântico."},subtopics:{type:"array",minItems:1,maxItems:6,items:{type:"string",description:"Rótulo visual curto, preferencialmente com até doze palavras."}}}}}}},
